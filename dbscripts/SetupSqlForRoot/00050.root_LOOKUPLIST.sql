...
(ID, REVISION, ENTITY_VERSION, DOMAIN_ID, VERSION, CREATE_USER,UPDATE_USER,CREATED_ON, UPDATED_ON, NAME,APPLY_TO_ENTITY, REF_NO, DOC_STATUS,REMARKs)
SELECT LOWER(SYS_GUID()), 1, 1, '/', NULL, 'system','system',sysdate,sysdate,'UOM_CONVERSION_RATE',4,'UOM_CONVERSION_RATE','active','UOM CONVERSION RATE'  FROM DUAL 
...
INSERT INTO CNT_LOOKUP_BOOK (ID,REVISION, ENTITY_VERSION,DOMAIN_ID, VERSION,STATUS,DOC_STATUS, editing_status, CREATE_USER, update_user, created_on, updated_on,NAME,DESCRIPTION, data_list_type_id, ref_no)
SELECT LOWER(SYS_GUID()),1,1,'/',0,NULL,'active','confirmed','system','system', sysdate, sysdate,'UOM_CONVERSION_RATE','UOM CONVERSION RATE',
(select id from cnt_data_list_type where name = 'UOM_CONVERSION_RATE' and domain_id = '/'),'UOM_CONVERSION_RATE'
FROM DUAL
...
INSERT INTO CNT_DATA_LIST_TYPE (ID, REVISION, ENTITY_VERSION, DOMAIN_ID, VERSION, CREATE_USER,UPDATE_USER,CREATED_ON, UPDATED_ON, NAME,APPLY_TO_ENTITY, REMARKS, REF_NO)
SELECT LOWER(SYS_GUID()), 1, 1, '/', 1, 'system','system',sysdate,sysdate,'CCY Exchange Rate', 4, 'CCY Exchange Rate','CCY Exchange Rate'  FROM DUAL 
...
INSERT INTO CNT_LOOKUP_BOOK (ID, REVISION, ENTITY_VERSION, DOMAIN_ID, VERSION, CREATE_USER, CREATED_ON, NAME, DESCRIPTION, DATA_LIST_TYPE_ID, REF_NO)SELECT LOWER(SYS_GUID()), 1, 1, '/', 1, 'system', sysdate, 'CCY_EXCHANGE_RATE','CCY Exchange Rate',(SELECT id FROM CNT_DATA_LIST_TYPE 
WHERE NAME = 'CCY Exchange Rate' and domain_id = '/' AND APPLY_TO_ENTITY = 4) as "dataListTypeId", 'CCY_EXCHANGE_RATE'  FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM CNT_LOOKUP_BOOK  WHERE DOMAIN_ID = '/' AND NAME = 'CCY_EXCHANGE_RATE');
...
INSERT INTO CNT_DATA_LIST_TYPE (ID, REVISION, ENTITY_VERSION, DOMAIN_ID, VERSION, CREATE_USER,UPDATE_USER,CREATED_ON, UPDATED_ON, NAME,APPLY_TO_ENTITY, REMARKS, REF_NO)
SELECT LOWER(SYS_GUID()), 1, 1, '/', 1, 'system','system',sysdate,sysdate,'Component Material Type', 2, 'Component Material Type','Component Material Type'  FROM DUAL 
